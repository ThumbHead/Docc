    ...
    // }
      ...
      const handleSubmit = (event) => {
        ...
        console.log("data..",name , gender, age ,email)
         var phone = localStorage.getItem('localPhoneNo', phone);
        ...
        axios
          .post('https://doccure-api.herokuapp.com/api/user/register-user', postData)
          .then((response) => {
...
<div class="form-group">
<label>Gender</label>
<select style={{height:'50px'}} class="form-select" name="gender" id="gender" 
  value={gender}
...
<button class="btn btn-primary btn-lg login-btn" onClick={handleSubmit} type="">Register</button>
</form>
