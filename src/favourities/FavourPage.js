              ...
              <div className="col-md-12 col-12">
                ...
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Bookmarks</li>
                  </ol>
                </nav>
              </div>
            </div>
                    ...
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        ...
                        <div className="profile-btn-list">
                          <a href="doctor-profile.html" className="btn book-btn">Book Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-lg-4 col-xl-3">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        ...
                        <p className="speciality">MD - Ophthalmology, DNB - Ophthalmology</p>
                        <p className="speciality">Clinic - Apollo <span style={{marginLeft: '65px'}}>Experience - 10+ years</span></p>
                        <ul className="available-info">
                          <li>
                            <i className="feather-map-pin" /> Mumbai
