...
export const DocRegister = () => {
    ...
    const [user, setUser] = useState({
        name:"", specialization:"", clinic:"", experience:"", email:"", location:"", phone:"" 
    });
                    ...
                    <div className="col-md-12 col-lg-6 login-right">
                      ...
                      <form action="doctor-dashboard.html">
                        <div className="custom-file" id="customFile1">
                          <div style={{marginBottom: '10px'}} className="avatar avatar-xxl">
                          ...
                          <p className="mb-0">Recommended image size is 35px x 35px</p>
                          <br />
                        </div>
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" name="specialization" id="specialization" className="form-control"
                          value={user.specialization}
                          onChange={handleInputs}
                         />
                        </div>
                        <div className="form-group">
                          <label className="focus-label">Clinic</label>
                          <input type="text" name="clinic" id="clinic" className="form-control"
                          value={user.clinic}
                          onChange={handleInputs}
                         />
                        </div>
                        <div className="form-group">
                          ...
                          <input type="text" name="experience" id="experience" className="form-control" 
                        ...
                        <button className="btn btn-primary w-100 btn-lg login-btn" onClick={onSubmit} type="submit">Register</button>
                      </form>
                    </div>
                  </div>
                </div>
